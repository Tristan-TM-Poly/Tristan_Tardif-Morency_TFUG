...
Runs conservative checks across the HGFM documentation layer and HyperRevenue
productization layer. This is a review assistant, not an autonomous publisher.
It does not merge PRs, deploy, create payment links, upload Drive files, or
promote scientific/revenue claims.
"""
