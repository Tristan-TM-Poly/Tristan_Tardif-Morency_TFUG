...
JSON_REPORT = ARTIFACTS / "ai7_tristan2_corridor_bundle_report_generated_2026-04-14.json"
MD_REPORT = ARTIFACTS / "ai7_tristan2_corridor_bundle_report_generated_2026-04-14.md"

SCRIPTS = [
    "build_monitoring_to_contradiction_chain_generated_2026-04-14.py",
...
def build_markdown(results: list[dict]) -> str:
    lines = [
        "# AI7_TRISTAN2_CORRIDOR_BUNDLE_REPORT — Generated Snapshot (2026-04-14)",
        "",
    ...
    lines += [
        "",
        "## Law",
        "This corridor bundle exists to keep sensing, contradiction, review, and promotion corridors auditable from one chain.",
    ]
    return "\n".join(lines) + "\n"
