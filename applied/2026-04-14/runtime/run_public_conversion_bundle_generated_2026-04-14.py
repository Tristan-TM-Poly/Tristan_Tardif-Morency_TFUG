...
JSON_REPORT = ARTIFACTS / "public_conversion_bundle_report_generated_2026-04-14.json"
MD_REPORT = ARTIFACTS / "public_conversion_bundle_report_generated_2026-04-14.md"

SCRIPTS = [
    "build_at1_homepage_copy_generated_2026-04-14.py",
    "build_public_site_map_generated_2026-04-14.py",
    "build_interactive_demo_spec_generated_2026-04-14.py",
    "build_company_layer_packet_generated_2026-04-14.py",
    "build_company_collaboration_packet_generated_2026-04-14.py",
]
...
def build_markdown(results: list[dict]) -> str:
    lines = [
        "# PUBLIC_CONVERSION_BUNDLE_REPORT — Generated Snapshot (2026-04-14)",
        "",
    ...
    lines += [
        "",
        "## Law",
        "This public conversion bundle exists to keep homepage copy, site map, demo spec, and company collaboration layers generated from one auditable chain.",
    ]
    return "\n".join(lines) + "\n"
