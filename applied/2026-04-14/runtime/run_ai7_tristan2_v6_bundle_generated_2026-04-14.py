...
JSON_REPORT = ARTIFACTS / "ai7_tristan2_v6_bundle_report_generated_2026-04-14.json"
MD_REPORT = ARTIFACTS / "ai7_tristan2_v6_bundle_report_generated_2026-04-14.md"
...
def build_markdown(results: list[dict]) -> str:
    lines = [
        "# AI7_TRISTAN2_V6_BUNDLE_REPORT — Generated Snapshot (2026-04-14)",
        "",
    ...
    lines += [
        "",
        "## Law",
        "This V6 bundle exists to keep the current AI-7 and TRISTAN2 runtime-closure layer auditable and runnable from one chain.",
    ]
    return "\n".join(lines) + "\n"
