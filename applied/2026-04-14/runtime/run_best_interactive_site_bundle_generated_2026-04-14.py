...
JSON_REPORT = ARTIFACTS / 'best_interactive_site_bundle_report_generated_2026-04-14.json'
MD_REPORT = ARTIFACTS / 'best_interactive_site_bundle_report_generated_2026-04-14.md'
...
def build_markdown(results: list[dict]) -> str:
    lines = [
        '# BEST_INTERACTIVE_SITE_BUNDLE_REPORT — Generated Snapshot (2026-04-14)',
        '',
    ...
    lines += [
        '',
        '## Law',
        'This bundle exists to keep the strongest current interactive site surfaces coupled to TFUGA, AI-7, TRISTAN2, Yggdrasil, AI-BOTS, and life-project routes.',
    ]
    return '\n'.join(lines) + '\n'
