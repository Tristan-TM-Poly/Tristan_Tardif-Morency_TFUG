...
JSON_REPORT = ARTIFACTS / 'unified_public_app_bundle_report_generated_2026-04-14.json'
MD_REPORT = ARTIFACTS / 'unified_public_app_bundle_report_generated_2026-04-14.md'
...
def build_markdown(results: list[dict]) -> str:
    lines = [
        '# UNIFIED_PUBLIC_APP_BUNDLE_REPORT — Generated Snapshot (2026-04-14)',
        '',
    ...
    lines += [
        '',
        '## Law',
        'This bundle exists to keep the unified public app shell coupled to release, interactive, and membership layers.',
    ]
    return '\n'.join(lines) + '\n'
