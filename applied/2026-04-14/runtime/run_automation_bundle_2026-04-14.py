...
JSON_REPORT = ARTIFACTS / "automation_bundle_report_2026-04-14.json"
MD_REPORT = ARTIFACTS / "automation_bundle_report_2026-04-14.md"
...
def build_markdown(results: list[dict]) -> str:
    lines = [
        "# AUTOMATION_BUNDLE_REPORT — Generated Snapshot (2026-04-14)",
        "",
    ...
    lines += [
        "",
        "## Law",
        "This automation report exists to make the current automation layer auditable without hiding failures.",
    ]
    return "\n".join(lines) + "\n"
