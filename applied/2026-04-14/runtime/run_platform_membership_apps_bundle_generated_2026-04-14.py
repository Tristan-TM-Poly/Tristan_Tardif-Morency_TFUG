...
JSON_REPORT = ARTIFACTS / 'platform_membership_apps_bundle_report_generated_2026-04-14.json'
MD_REPORT = ARTIFACTS / 'platform_membership_apps_bundle_report_generated_2026-04-14.md'

SCRIPTS = [
    'build_platform_stack_map_generated_2026-04-14.py',
...
def build_markdown(results: list[dict]) -> str:
    lines = [
        '# PLATFORM_MEMBERSHIP_APPS_BUNDLE_REPORT — Generated Snapshot (2026-04-14)',
        '',
    ...
    lines += [
        '',
        '## Law',
        'This bundle exists to keep website, desktop app, Android app, memberships, subscriptions, and donation surfaces coupled to the sovereign stack.',
    ]
    return '\n'.join(lines) + '\n'
