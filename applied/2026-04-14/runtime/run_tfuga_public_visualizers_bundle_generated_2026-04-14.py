...
JSON_REPORT = ARTIFACTS / "tfuga_public_visualizers_bundle_report_generated_2026-04-14.json"
MD_REPORT = ARTIFACTS / "tfuga_public_visualizers_bundle_report_generated_2026-04-14.md"
...
def build_markdown(results: list[dict]) -> str:
    lines = [
        "# TFUGA_PUBLIC_VISUALIZERS_BUNDLE_REPORT — Generated Snapshot (2026-04-14)",
        "",
    ...
    lines += [
        "",
        "## Law",
        "This visualizers bundle exists to keep the public TFUGA visual layer coupled to the trinity and auditable from one chain.",
    ]
    return "\n".join(lines) + "\n"
