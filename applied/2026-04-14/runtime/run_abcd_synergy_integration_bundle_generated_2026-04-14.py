...
JSON_REPORT = ARTIFACTS / "abcd_synergy_integration_bundle_report_generated_2026-04-14.json"
MD_REPORT = ARTIFACTS / "abcd_synergy_integration_bundle_report_generated_2026-04-14.md"

SCRIPTS = [
    "build_abcd_synergy_site_map_generated_2026-04-14.py",
    "build_abcd_synergy_everywhere_matrix_generated_2026-04-14.py",
...
def build_markdown(results: list[dict]) -> str:
    lines = [
        "# ABCD_SYNERGY_INTEGRATION_BUNDLE_REPORT — Generated Snapshot (2026-04-14)",
        "",
    ...
    lines += [
        "",
        "## Law",
        "This bundle exists to keep A/B/C/D synergy families integrated across the public web, demos, AI-BOTS, Yggdrasil, runtime, and research layers.",
    ]
    return "\n".join(lines) + "\n"
