...
JSON_REPORT = ARTIFACTS / "tfuga_auto_generative_web_bundle_report_generated_2026-04-14.json"
MD_REPORT = ARTIFACTS / "tfuga_auto_generative_web_bundle_report_generated_2026-04-14.md"
...
def build_markdown(results: list[dict]) -> str:
    lines = [
        "# TFUGA_AUTO_GENERATIVE_WEB_BUNDLE_REPORT — Generated Snapshot (2026-04-14)",
        "",
    ...
    lines += [
        "",
        "## Law",
        "This auto-generative web bundle exists to keep module generation, integration, and public visual surfaces auditable from one chain.",
    ]
    return "\n".join(lines) + "\n"
