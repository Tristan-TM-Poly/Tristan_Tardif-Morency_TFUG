...
JSON_REPORT = ARTIFACTS / "tfuga_edugame_hypergraph_bundle_report_generated_2026-04-14.json"
MD_REPORT = ARTIFACTS / "tfuga_edugame_hypergraph_bundle_report_generated_2026-04-14.md"
...
def build_markdown(results: list[dict]) -> str:
    lines = [
        "# TFUGA_EDUGAME_HYPERGRAPH_BUNDLE_REPORT — Generated Snapshot (2026-04-14)",
        "",
    ...
    lines += [
        "",
        "## Law",
        "This bundle exists to keep educational gameplay, NPC guidance, and hypergraph growth surfaces auditable from one chain.",
    ]
    return "\n".join(lines) + "\n"
