...
OUTPUT_JSON = ARTIFACTS / "tfuga_trinity_packet_family_bundle_report_generated_2026-04-14.json"
OUTPUT_MD = ARTIFACTS / "tfuga_trinity_packet_family_bundle_report_generated_2026-04-14.md"
...
def build_markdown(results: list[dict]) -> str:
    lines = [
        "# TFUGA_TRINITY_PACKET_FAMILY_BUNDLE_REPORT — Generated Snapshot (2026-04-14)",
        "",
    ...
    lines += [
        "",
        "## Law",
        "The TFUGA trinity packet family bundle exists to keep the trinity packet stack auditable from one chain.",
    ]
    return "\n".join(lines) + "\n"
