...
JSON_REPORT = ARTIFACTS / 'best_public_release_bundle_report_generated_2026-04-14.json'
MD_REPORT = ARTIFACTS / 'best_public_release_bundle_report_generated_2026-04-14.md'

SCRIPTS = [
    'build_abcd_synergy_site_map_generated_2026-04-14.py',
    'run_best_interactive_site_bundle_generated_2026-04-14.py',
...
def build_markdown(results: list[dict]) -> str:
    lines = [
        '# BEST_PUBLIC_RELEASE_BUNDLE_REPORT — Generated Snapshot (2026-04-14)',
        '',
    ...
    lines += [
        '',
        '## Law',
        'This bundle exists to keep the strongest public release surfaces bundled, readable, and coupled to the sovereign stack.',
    ]
    return '\n'.join(lines) + '\n'
