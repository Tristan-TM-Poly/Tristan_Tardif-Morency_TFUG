...
JSON_REPORT = ARTIFACTS / "auto_generator_web_bundle_report_generated_2026-04-14.json"
MD_REPORT = ARTIFACTS / "auto_generator_web_bundle_report_generated_2026-04-14.md"

SCRIPTS = [
    "build_auto_generator_catalog_generated_2026-04-14.py",
    "build_auto_generator_cards_generated_2026-04-14.py",
...
def build_markdown(results: list[dict]) -> str:
    lines = [
        "# AUTO_GENERATOR_WEB_BUNDLE_REPORT — Generated Snapshot (2026-04-14)",
        "",
    ...
    lines += [
        "",
        "## Law",
        "This auto-generator web bundle exists to keep generator families, public visualizers, and trinity-coupled web surfaces auditable from one chain.",
    ]
    return "\n".join(lines) + "\n"
