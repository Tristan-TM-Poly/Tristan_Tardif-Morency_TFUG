...
import PublicLaunchPageGenerated from './PublicLaunchPageGenerated';
import HostingReadinessReportGenerated from './HOSTINGReadinessReportGenerated';
...
export default function PublicAppRouterGeneratedV7b() {
  ...
  const renderRoute = () => {
    switch (route) {
      ...
      case 'launch':
        return <PublicLaunchPageGenerated />;
      case 'hosting':
        return <HostingReadinessReportGenerated />;
      case 'release':
